package com.levelup.bazquxforpalabre.ui.fragment;
...
import com.levelup.bazquxforpalabre.LoginReceivedListener;
import com.levelup.bazquxforpalabre.R;
import com.levelup.bazquxforpalabre.SharedPreferenceKeys;
import com.levelup.bazquxforpalabre.BazquxExtension;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        signinButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("Bazqux", "Log in bazqux");

                Ion.with(getActivity())
                        .load("https://www.bazqux.com/accounts/ClientLogin?Email=" + username + "&Passwd=" + password + "&output=json")
                        //.setBodyParameter("client", "Bazqux For Palabre")
                        ...
                        .setCallback(new FutureCallback<JsonObject>() {
                            ...
                            public void onCompleted(Exception e, JsonObject result) {
                                if (result != null && result.has("Auth")) {
                                    ...
                                    BazquxExtension.fetchCategories(getActivity(), result.get("Auth").getAsString(), new BazquxExtension.OnCategoryAndSourceRefreshed() {
                                        @Override
