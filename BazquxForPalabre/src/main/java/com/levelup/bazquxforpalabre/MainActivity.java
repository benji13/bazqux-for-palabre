...
import com.levelup.bazquxforpalabre.ui.fragment.LoginFragment;
import com.levelup.bazquxforpalabre.ui.fragment.ManageSourceFragment;

import java.util.List;

public class MainActivity extends AppCompatActivity implements LoginReceivedListener {
    public static final String CATEGORY_SOURCE_REFRESHED = "com.levelup.bazquxforpalabre.MainActivity";
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (e != null || (result.get("numResults") != null && result.get("numResults").getAsInt() > 0)) {
                            BazquxExtension.fetchCategories(MainActivity.this, authKey, new BazquxExtension.OnCategoryAndSourceRefreshed() {
                                @Override
